...
public class FeaturestoreRemoveTagFromFeaturegroup extends FeaturestoreOp {
  
  public FeaturestoreRemoveTagFromFeaturegroup(String name) {
    super(name);
  }
  ...
  public FeaturestoreRemoveTagFromFeaturegroup setFeaturestore(String featurestore) {
    this.featurestore = featurestore;
    return this;
  }
  
  public FeaturestoreRemoveTagFromFeaturegroup setVersion(int version) {
    this.version = version;
    return this;
  }

  public FeaturestoreRemoveTagFromFeaturegroup setTag(String tag) {
    this.tag = tag;
    return this;
  }
